...
const PracticeMiniCardLeft = ({ title = "Grammar Drill", status = "in_progress", icon, onPress }) => {
...
const styles = StyleSheet.create({
  card: {
    ...
    padding: 12,
    width: 220,
    alignSelf: 'flex-start', // sola yaslı
    marginLeft: 40, // biraz içeriden gelsin
    marginVertical: 8,
  },
  icon: {
    width: 48,
...
export default PracticeMiniCardLeft;
